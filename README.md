...
- A **100,000-rating stratified sample** is used for modeling (consistent with the MovieLens 100K benchmark)
...
| Finding | Evidence |
|---------|----------|
| **Biased SVD achieves lowest RMSE and MAE** | Overall performance comparison table |
